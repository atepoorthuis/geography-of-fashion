...
An interactive version of the maps related to this paper (including all keywords, instead of the limited number of figures in the paper) is available at: [https://geography-of-fashion.netlify.com](https://geography-of-fashion.netlify.com).
